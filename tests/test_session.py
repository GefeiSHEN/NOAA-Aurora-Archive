...
class SessionTests(unittest.TestCase):
    def test_utc_slots_and_rollover(self):
        for value, expected in (
            ('2026-09-22T23:57:00+00:00', '2026-09-23T00:02:00+00:00'),
            ('2026-09-22T17:41:59+00:00', '2026-09-22T17:42:00+00:00'),
            ('2026-09-22T12:42:01-05:00', '2026-09-22T17:47:00+00:00'),
        ):
    ...
    def test_delayed_start_collects_now_then_on_utc_boundaries(self):
        ...
        calls = []
        self.run_session(clock, lambda: calls.append(clock.now))
        self.assertEqual([d.strftime('%H:%M') for d in calls], ['17:43', '17:47', '17:52'])
    ...
    def test_slow_fetch_skips_missed_slots_without_catchup_frames(self):
        ...
        self.assertEqual([d.strftime('%H:%M') for d in calls], ['17:42', '17:52'])
    ...
    def test_rejects_unbounded_session(self):
        for minutes in (0, -1, 341):
            with self.assertRaises(ValueError):
                session.run(lambda: None, minutes=minutes)
